/* =====================================================================
   経営管理システム capacity.js
   2026-07-23
   ・キャパシティ管理（§19 RENDER — Capacity）をapp.jsから分離
   ・STATE / STORE / CLOUD / NAV / UI / 共通フォーマット関数はapp.js側を使用
   ・このファイルは地区キャパ・荷主別キャパ・カレンダー表示のみ担当
===================================================================== */
'use strict';

(function(){
  if (window.__CAPACITY_MODULE_LOADED_20260723__) return;
  window.__CAPACITY_MODULE_LOADED_20260723__ = true;
