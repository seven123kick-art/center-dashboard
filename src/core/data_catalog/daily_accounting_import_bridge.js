...
(function(){
  ...
  function normalizeCsvText(text,input={}){if(!window.DAILY_ACCOUNTING_NORMALIZER?.normalizeRows||!window.CSV?.toRows)throw new Error('DEPENDENCY_UNAVAILABLE');return DAILY_ACCOUNTING_NORMALIZER.normalizeRows(CSV.toRows(text),{file_name:input.file_name||null,source_file_id:input.source_file_id||null});}
