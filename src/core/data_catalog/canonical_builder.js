  ...
  function buildDetailedEntitiesFromNormalizedSources(workerSalesRecords, shipperAreaRecords, existingBusinessSlips) {
    ...
    workers.forEach((r, idx) => {
      ...
      const detail = {
        ...
        attribution_subject_type: null,
        attribution_subject_id: null,
        worker_id: null,
        worker_company_id: null,
        attribution_center_id: null,
        process_code: null,
        ...
        source_subject_label: r.source_worker_name || null,
        source_subject_company_name: r.source_worker_company_name || null,
    ...
    shippers.forEach((r, idx) => {
      ...
      if (workerSlipDetails.length === 0) {
        ...
        salesDetails.push({
          ...
          source_subject_company_name: null,
