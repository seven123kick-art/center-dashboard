...
(function(){
  ...
  function ensureStyles(){
    ...
    st.textContent = `
      ...
      .fc-kpi{background:#fff;border:1px solid var(--border);border-radius:16px;box-shadow:var(--shadow);border-top:5px solid #1a4d7c;padding:16px;min-height:104px}.fc-kpi.green{border-top-color:#059669}.fc-kpi.amber{border-top-color:#f97316}.fc-kpi-label{font-size:12px;font-weight:900;color:#334155;margin-bottom:8px}.fc-kpi-value{font-size:28px;font-weight:900;color:#0f172a;line-height:1.1;white-space:nowrap}.fc-kpi-sub{font-size:12px;color:#8291a7;font-weight:800;margin-top:8px;line-height:1.45}
